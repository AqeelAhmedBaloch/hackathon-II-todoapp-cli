    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-8">
          ...
          <p className="text-slate-500 mt-1">Right work at the right time, {user?.full_name}</p>
        </header>
        ...
        {/* Actions Bar */}
        <div className="flex justify-between items-center mb-8 bg-slate-900/50 p-3 rounded-xl border border-white/5 backdrop-blur-sm">
        ...
        {/* Grid of Tasks with Empty State */}
        {loading ? (
          ...
          <div className="glass-panel rounded-xl border border-white/10 p-16 text-center">
            ...
            <p className="text-slate-500 mt-2 max-w-sm mx-auto">
              Your task list is currently empty. Add your first task to see the premium glassmorphic cards in action!
            </p>
            <button
