...
const GlassSidebar = () => {
    ...
    const navItems = [
        ...
        // { icon: BarChart2, label: 'Analytics', path: '/analytics' }, // Disabled for Phase 4
        // { icon: Calendar, label: 'Calendar', path: '/calendar' }, // Disabled for Phase 4
    ];
    ...
    return (
        ...
        >
            <div className="p-8">
                ...
                <p className="text-xs text-slate-500 mt-1">Phase 4</p>
            </div>
