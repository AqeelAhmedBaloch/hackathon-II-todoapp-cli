      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="glass-panel rounded-xl p-8 border border-white/10 cyber-card">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2 font-normal text-sm">Enter your credentials to access your account</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="email" className="block text-xs font-semibold text-cyan-500/80 mb-1 uppercase tracking-wider">
                Email Address
              </label>
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-cyan-500/80 mb-1 uppercase tracking-wider">
                Password
              </label>
              <div className="relative group">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 text-white py-3 px-4 rounded-lg font-bold tracking-wide hover:from-cyan-500 hover:to-blue-500 focus:outline-none ring-1 ring-white/10 shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] transition-all disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden"
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-slate-400">
              New User?{' '}
              <Link to="/register" className="font-medium text-cyan-400 hover:text-cyan-300 transition-colors hover:underline decoration-cyan-500/30 underline-offset-4">
                Create an Account
              </Link>
            </p>
          </div>
