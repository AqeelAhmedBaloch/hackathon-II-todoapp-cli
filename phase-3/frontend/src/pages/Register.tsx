      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="glass-panel rounded-xl p-8 border border-white/10 cyber-card">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2 text-sm">Join Phase 3 Premium Community</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-violet-500/80 mb-1 uppercase tracking-wider">Full Name</label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    type="text"
                    required
                    className="w-full pl-10 pr-4 py-3 bg-slate-950/50 border border-white/10 rounded-lg focus:ring-1 focus:ring-violet-500 focus:border-violet-500 text-slate-200 placeholder-slate-600 transition-all font-sans"
              ...
              <div>
                <label className="block text-xs font-semibold text-violet-500/80 mb-1 uppercase tracking-wider">Email Address</label>
                <div className="relative group">
              ...
              <div>
                <label className="block text-xs font-semibold text-violet-500/80 mb-1 uppercase tracking-wider">Password</label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-12 py-3 bg-slate-950/50 border border-white/10 rounded-lg focus:ring-1 focus:ring-violet-500 focus:border-violet-500 text-slate-200 placeholder-slate-600 transition-all font-sans"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-500 hover:text-violet-400"
                  >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white py-3 px-4 rounded-lg font-bold tracking-wide hover:from-violet-500 hover:to-fuchsia-500 shadow-[0_0_20px_rgba(139,92,246,0.3)] transition-all disabled:opacity-50"
            >
              <span className="relative">{loading ? 'Creating Account...' : 'Sign Up'}</span>
            </button>
          </form>

          <div className="mt-8 text-center text-sm text-slate-400 font-sans">
