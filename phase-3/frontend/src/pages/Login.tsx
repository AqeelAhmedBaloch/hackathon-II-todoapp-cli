      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="glass-panel rounded-xl p-8 border border-white/10 cyber-card">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2 text-sm">Access Phase 3 Premium Dashboard</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  type="email"
                  required
                  className="w-full pl-10 pr-4 py-3 bg-slate-950/50 border border-white/10 rounded-lg focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500 text-slate-200 placeholder-slate-600 transition-all font-sans"
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-12 py-3 bg-slate-950/50 border border-white/10 rounded-lg focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500 text-slate-200 placeholder-slate-600 transition-all font-sans"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 text-white py-3 px-4 rounded-lg font-bold tracking-wide hover:from-cyan-500 hover:to-blue-500 shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all disabled:opacity-50"
            >
